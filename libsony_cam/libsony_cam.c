...
extern void _ZN7android19GraphicBufferMapper4lockEPK13native_handlejRKNS_4RectEPPv(buffer_handle_t handle, unsigned int usage, const Rect& bounds, void** vaddr);
