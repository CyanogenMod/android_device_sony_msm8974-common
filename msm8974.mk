...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/audio/media_codecs.xml:system/etc/media_codecs.xml \
    $(COMMON_PATH)/audio/media_codecs_performance.xml:system/etc/media_codecs_performance.xml \
    $(COMMON_PATH)/audio/media_profiles.xml:system/etc/media_profiles.xml
